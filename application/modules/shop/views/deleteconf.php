...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<?php 
			...
			echo form_open('index.php/shop/delete/'.$update_id, $attributes);
		?>

			  <fieldset>
				<div class="control-group" style="height: 100px; margin-top: 50px">
				  <button type="submit" name="submit" value="Yes - Delete Shop" class="btn btn-danger">Yes - Delete Shop</button>

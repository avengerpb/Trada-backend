			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?= base_url() ?>index.php/store_items/manage"><i class="icon-tag"></i><span class="hidden-tablet"> Manage Items</span></a></li>
						<li><a href="<?= base_url() ?>index.php/store_categories/manage"><i class="icon-align-justify"></i><span class="hidden-tablet"> Manage Categories</span></a></li>
						<li><a href="<?= base_url() ?>index.php/shop/manage"><i class="icon-file"></i><span class="hidden-tablet"> Manage Shop</span></a></li>
						<li><a href="<?= base_url() ?>index.php/store_users/manage_users"><i class="icon-briefcase"></i><span class="hidden-tablet"> Users</span></a></li>
